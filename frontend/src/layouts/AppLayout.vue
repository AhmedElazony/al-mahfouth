			...
			<div class="px-4 sm:px-6 lg:px-8">
				<div class="flex items-center justify-between h-16">
					...
					<div class="flex items-center gap-4">
						<router-link :to="homeRoute"
							class="text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-200 transition-colors font-bold text-lg flex items-center gap-3">
					...
					<div class="flex items-center gap-2">
						...
						<div class="relative" ref="userMenuRef">
							...
							<div v-if="showUserMenu"
								...
								<router-link :to="settingsRoute" @click="closeUserMenu"
				...
				<transition enter-active-class="transition duration-200 ease-out"
					...
					<nav v-if="showMobileMenu"
						...
						<!-- Student Mobile Nav -->
						<template v-if="authStore.isStudent">
							<router-link to="/student" exact @click="closeMobileMenu"
							...
							<router-link to="/student/groups" @click="closeMobileMenu"
								class="block px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700/50 rounded-lg transition-colors"
								active-class="!text-primary-600 dark:!text-primary-400 bg-primary-50 dark:bg-primary-900/20 font-medium">
								<i class="pi pi-users mr-2"></i>
								{{ $t('students.myGroups') }}
						...
						<!-- Admin/Teacher Mobile Nav -->
						<template v-else>
							<router-link to="/dashboard" exact @click="closeMobileMenu"
								class="block px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700/50 rounded-lg transition-colors"
								active-class="!text-primary-600 dark:!text-primary-400 bg-primary-50 dark:bg-primary-900/20 font-medium">
								<i class="pi pi-home mr-2"></i>
								{{ $t('nav.dashboard') }}
						...
						<router-link :to="settingsRoute" @click="closeMobileMenu"
							class="block px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700/50 rounded-lg transition-colors"
							active-class="!text-primary-600 dark:!text-primary-400 bg-primary-50 dark:bg-primary-900/20 font-medium">
...
// Computed routes based on role
const homeRoute = computed(() => {
	return '/'
})

const settingsRoute = computed(() => {
	return authStore.isStudent ? '/student/settings' : '/dashboard/settings'
})
