          ...
          <div v-else-if="students.length > 0" class="space-y-2">
            ...
            >
              ...
              <div v-else class="flex items-center gap-2">
                ...
                <span class="px-2 py-0.5 bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400 text-xs rounded-full">
                ...
                >
                  <i :class="removingStudentId === getStudentId(item) ? 'pi pi-spinner pi-spin' : 'pi pi-trash'" class="text-sm"></i>
                </button>
              </div>
            </div>
          </div>
